    ...
    class Program
    {
        ...
        public static Num GetFraction()
        {
            ...
            try
            {
                ...
                return new Num(int.Parse(arr[0]), int.Parse(arr[1]));
            }
            catch
            {
                return new Num(int.Parse(str), 1);
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"2. {num1.ShowAsFraction} * {num2.ShowAsFraction} = " + (num1 * num2).ShowAsFraction);
            ...
            Console.WriteLine($"   {num1.ShowAsNumber} != {num2.ShowAsNumber} = " + (num1 != num2) + "\n");
            Console.WriteLine($"5. {num1.ShowAsFraction} == {num2.ShowAsFraction} = " + (num1 == num2));
            Console.WriteLine($"   {num1.ShowAsNumber} == {num2.ShowAsNumber} = " + (num1 == num2) + "\n");
